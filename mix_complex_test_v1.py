...
def test_pytorch_in_tensorflow_graph_mode():
	...
	tf.print("TF weight init: ", tf_layer.trainable_variables)
	print("PT weight init: ", list(pt_layer.parameters()))
	@tf.function
	...
	tf.print("TF weight final: ", tf_layer.trainable_variables)
	print("PT weight final: ", list(pt_layer.parameters()))
	return
